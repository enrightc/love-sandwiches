...
def get_sales_data():
    ...
    via the terminal, which must be a strong of 6 numbers separated
...
def validate_data(values):
    ...
    Raises the ValueError, if strings cannot be converted into int,
...
def update_surplus_worksheet(data):
    ...
    # Update surplus worksheet, add new row stock - sales
